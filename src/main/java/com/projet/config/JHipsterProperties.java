...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "GestionProjet@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "GestionProjet API";

        private String description = "GestionProjet API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "GestionProjet";
